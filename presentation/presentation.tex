...
\begin{frame}{Biologische Bedeutung}
    ...
    \begin{columns}
        ...
        \begin{figure}
            \centering
            % \includegraphics[width=\linewidth]{images/negative_autoregulation_low_affinity.m.png}
        \end{figure}
    \end{columns}
    % @Xaver: Macht @Mario noch am Sonntag sofern du nicht schon vorher Lust drauf hast. Kommt dann auch noch mit dem Aufzeigen von verschiedenen Parametern zustande.


    % Startkonzentration = 0 ist biologisch eher unwahrscheinlich
    % Ermöglicht einen Stoff auf konstantem Level zu halten
    % Kurve ist leicht anpassbar, im Endeffekt müssen nur Affinitäten verändert werden 
\end{frame}
